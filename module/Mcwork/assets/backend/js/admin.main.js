...
var translation = {
		...
		'default' : {
			...
			'imgtitletext': 'Title Text (for example, for copyright information)',
		...
		'de_DE' : {
		    ...
		    'itemfile' : 'Datei',
			'imgalttext': 'Alternativtext <em>(stichwortartige Erkl&auml;rung, die bei Nichterscheinen der Datei angezeigt wird)</em>',
			'imgtitletext': 'Titel Text <em>(z.B. f&uuml;r Copyrightangaben)</em>',
